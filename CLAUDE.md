...
**YOU ARE IN: `beta/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/beta/` (rig root) or other directories
...
**Your mail address:** `beta/polecats/obsidian`
**Your rig:** beta
**Your Witness:** `beta/witness`
...
| Ask Witness for help | `gt mail send beta/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`beta/witness`) when:
...
```bash
gt mail send beta/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
